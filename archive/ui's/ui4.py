...
def process_form_submission():
    ...
    st.rerun() # Rerun to refresh form with latest validation
...
if st.session_state.session_created:
    ...
    uploaded_file = st.file_uploader("Selecione o arquivo PDF da fatura", type=['pdf'], help="Apenas arquivos PDF são aceitos")
    ...
    if st.session_state.invoice_data and st.session_state.uploaded_pdf:
        ...
        with col_form:
            ...
            st.info("📝 Revise e edite os campos abaixo. Os ícones indicam o status de validação.")
